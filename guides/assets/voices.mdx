...
| **`provider`** | Preset tier code `S1`, `S2`, … | Clone engine `V1`–`V5` |
...
<Note>
  Preset tier codes (`S1`, `S2`, …) and clone engines (`V1`–`V5`) are product codes for API use. They are not vendor or model names.
</Note>
