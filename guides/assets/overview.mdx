...
Materials and voices created through the API are not shared with files or voices you manage on [vmeg.ai](https://www.vmeg.ai/home). Use `/openapi/assets/**` only. API tasks are separate too; see [Products overview](/guides/products/overview).
