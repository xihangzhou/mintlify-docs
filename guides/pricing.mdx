...
| [Text translation](/guides/products/text-translation) | `POST /openapi/v1/task/translate/create`, `.../create-async` | Per billed minute (from request size / duration rules) | **1 credit / min** |
